...
/**
 * Cache Manager will initiate the cache from the cache config.
 */
public class CacheManager {
    ...
    /**
     * Get cache lines from the cache config file.
     * @param cacheConf is the param of the cache conf file
     * @return the List of the list of CacheLine
     */
